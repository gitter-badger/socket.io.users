...
gulp.task("src", function () { // compile and copy to examples and compiled folder
	...
	return gulp.src(["src/**/*.ts", "src/**/**/*.ts"]) //lib //except lib.d.ts. Maybe for future use:  { base: './src/' }
		...
		.pipe(gulp.dest("./examples_typescript/node_modules/socket.io.users/compiled/"));
});
...
gulp.task("typings", function () {
	...
	return gulp.src(["definitely_typed/**/*d.ts"])
		...
		.pipe(gulp.dest("./examples_javascript/node_modules/socket.io.users/compiled/typings/"))
		.pipe(gulp.dest("./examples_typescript/node_modules/socket.io.users/compiled/typings/"));
});
    ...
    stream.queue(
        gulp.src(
            [
				...
				"!./examples_typescript/node_modules/socket.io.users/**"
            ],
            { base: "." })
		);
